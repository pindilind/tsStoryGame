interface StepGame { //visar sidID, fråga och val
    id: number
    question: string
    choices: {
...
let gameSteps: StepGame[] = [ //skapar array av av objekt från interface
    {
        id: 1,
...
let question = document.querySelector("#question") as HTMLElement //hämta question div
let leftBtn = document.querySelector("#leftBtn") as HTMLElement //hämtar vänster knapp
let rightBtn = document.querySelector("#rightBtn") as HTMLElement //hämtar höger knapp

let actualStep: StepGame
...
function toNextStep(choice: string) {
    let nextStep: StepGame | undefined
